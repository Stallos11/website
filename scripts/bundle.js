var yourDate = '2023-07-03'; // Your date here
!(function (e) {
  var t = {};
      ...
      e.exports = (function () {
        ...
        function H(e, t) {
          var a,
            s = c({}, e);
          for (a in t)
            d(t, a) && (i(e[a]) && i(t[a]) ? ((s[a] = {}), c(s[a], e[a]), c(s[a], t[a])) : null != t[a] ? (s[a] = t[a]) : delete s[a]);
              ...
              (W[t] =
                ...
                (function (e) {
                  ...
                  for (t = 0, a = n.length; t < a; t++)
                    E[n[t]] ? (n[t] = E[n[t]]) : (n[t] = (s = n[t]).match(/\[[\s\S]/) ? s.replace(/^\[|\]$/g, '') : s.replace(/\\/g, ''));
                  return function (t) {
                    var s,
                      r = '';
        ...
        function Ue(e, t, a, s, n) {
          ...
          return (
            d <= 0 ? (i = Je((r = e - 1)) + d) : d > Je(e) ? ((r = e + 1), (i = d - Je(e))) : ((r = e), (i = d)),
            {
              year: r,
              dayOfYear: i,
            }
            ...
            a &&
              ...
              ((t =
                a[ge] < 0 || a[ge] > 11
                  ...
                  ? Te
                  : a[we] < 0 || a[we] > 24 || (24 === a[we] && (0 !== a[ve] || 0 !== a[be] || 0 !== a[Se]))
                  ? we
                  : a[ve] < 0 || a[ve] > 59
                  ? ve
                  : a[be] < 0 || a[be] > 59
        ...
        function vt(e) {
          ...
          if (o) {
            if (
              ...
              (i = o[6]),
              (d = o[7]),
              (_ = [wt(a), Pe.indexOf(s), parseInt(n, 10), parseInt(r, 10), parseInt(i, 10)]),
        ...
        function St(e) {
          ...
          if (!e._d) {
                  ...
                  (function (e) {
                    ...
                    null != (t = e._w).GG || null != t.W || null != t.E
                      ...
                      s < 1 || s > Ve(a, r, i)
                        ...
                        : ((d = Ue(a, s, n, r, i)), (e._a[De] = d.year), (e._dayOfYear = d.dayOfYear));
                  })(e),
                null != e._dayOfYear &&
                  ((i = bt(e._a[De], s[De])),
            ...
            24 === e._a[we] && 0 === e._a[ve] && 0 === e._a[be] && 0 === e._a[Se] && ((e._nextDay = !0), (e._a[we] = 0)),
              (e._d = (
                e._useUTC
                  ? Ce
          ...
          if (e._f !== n.ISO_8601)
            if (e._f !== n.RFC_2822) {
              ...
              var t,
                ...
                o = _.length,
                u = 0;
              for (s = z(e._f, e._locale).match(O) || [], t = 0; t < s.length; t++)
                (r = s[t]),
                  (a = (_.match(Me(r, e)) || [])[0]) &&
                    ((i = _.substr(0, _.indexOf(a))).length > 0 && M(e).unusedInput.push(i),
                    (_ = _.slice(_.indexOf(a) + a.length)),
                    (u += a.length)),
                  E[r] ? (a ? (M(e).empty = !1) : M(e).unusedTokens.push(r), pe(r, a, e)) : e._strict && !a && M(e).unusedTokens.push(r);
              (M(e).charsLeftOver = o - u),
                ...
                null !== (d = M(e).era) && (e._a[De] = e._locale.erasConvertYear(d, e._a[De])),
                St(e),
                Mt(e);
            } else vt(e);
          else Tt(e);
                      ...
                      ? (function (e) {
                          ...
                          for (n = 0; n < e._f.length; n++)
                            (r = 0),
                              ...
                              (M(t).score = r),
                              d ? r < s && ((s = r), (a = t)) : (null == s || r < s || i) && ((s = r), (a = t), i && (d = !0));
                          c(e, a || t);
                        })(e)
                      : a
                      ? Ht(e)
        ...
        function xt(e, t, a, s, n) {
          ...
          return (
            ...
            (o._f = t),
            (o._strict = s),
            (d = new k(Mt(jt(o))))._nextDay && (d.add(1, 'd'), (d._nextDay = void 0)),
            d
          );
        }
        ...
        function Ft(e) {
          ...
          (this._isValid = (function (e) {
            var t,
              a,
              s = !1;
            for (t in e) if (d(e, t) && (-1 === ke.call(At, t) || (null != e[t] && isNaN(e[t])))) return !1;
        ...
        function Ct(e, t) {
          ...
          return null === n
            ? null
            : 0 === (s = 60 * (a = ((n[n.length - 1] || []) + '').match(Rt) || ['-', 0, 0])[1] + B(a[2]))
            ? 0
            : '+' === a[0]
            ? s
            : -s;
        ...
        function It(e, t) {
          ...
          return t._isUTC
            ? ((a = t.clone()),
              (s = (D(e) || m(e) ? e.valueOf() : Ot(e).valueOf()) - a.valueOf()),
            ...
            zt(e)
              ...
              : 'object' == typeof o &&
                ...
                (n =
                  r.isValid() && i.isValid()
                    ? ((i = It(i, r)),
                      r.isBefore(i) ? (_ = Zt(r, i)) : (((_ = Zt(i, r)).milliseconds = -_.milliseconds), (_.months = -_.months)),
                      _)
                    : {
                        milliseconds: 0,
                        months: 0,
        ...
        A('N', 0, 0, 'eraAbbr'),
          ...
          ye(['yo'], function (e, t, a, s) {
            ...
            a._locale._eraYearOrdinalRegex && (n = e.match(a._locale._eraYearOrdinalRegex)),
              a._locale.eraYearOrdinalParse ? (t[De] = a._locale.eraYearOrdinalParse(e, n)) : (t[De] = parseInt(e, 10));
          }),
          A(0, ['gg', 2], 0, function () {
        ...
        (ga.add = Xt),
          ...
          (ga.toISOString = function (e) {
            ...
            return a.year() < 0 || a.year() > 9999
              ? F(a, t ? 'YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]' : 'YYYYYY-MM-DD[T]HH:mm:ss.SSSZ')
              : S(Date.prototype.toISOString)
              ? t
                ? this.toDate().toISOString()
                : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace('Z', F(a, 'Z'))
              : F(a, t ? 'YYYY-MM-DD[T]HH:mm:ss.SSS[Z]' : 'YYYY-MM-DD[T]HH:mm:ss.SSSZ');
          }),
          (ga.inspect = function () {
        ...
        (wa.calendar = function (e, t, a) {
          ...
          (n.lang = T('moment.lang is deprecated. Use moment.locale instead.', lt)),
          (n.langData = T('moment.langData is deprecated. Use moment.localeData instead.', ht));
        var Ha = Math.abs;
        ...
        return (
          ...
          (ss.as = function (e) {
            ...
            if ('month' === (e = R(e)) || 'quarter' === e || 'year' === e)
              switch (((t = this._days + s / 864e5), (a = this._months + Oa(t)), e)) {
                case 'month':
                  return a;
                case 'quarter':
                  return a / 3;
          ...
          (ss.locale = sa),
          (ss.localeData = ra),
          (ss.toIsoString = T('toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)', as)),
          (ss.lang = na),
          A('X', 0, 0, 'unix'),
          A('x', 0, 0, 'valueOf'),
          he('x', ue),
          ...
          (n.updateLocale = function (e, t) {
            if (null != t) {
              ...
              null != dt[e] &&
                (null != dt[e].parentLocale ? ((dt[e] = dt[e].parentLocale), e === lt() && lt(e)) : null != dt[e] && delete dt[e]);
            return dt[e];
          }),
          (n.locales = function () {
            return w(dt);
  ...
  function (e, t, a) {
    !(function (e) {
      ...
      e.defineLocale('id', {
        ...
        meridiemHour: function (e, t) {
          return (
            12 === e && (e = 0), 'pagi' === t ? e : 'siang' === t ? (e >= 11 ? e : e + 12) : 'sore' === t || 'malam' === t ? e + 12 : void 0
          );
        },
        meridiem: function (e, t, a) {
    ...
    !(function (e) {
      ...
      function b(e, t) {
        ...
        return a
          ...
          : ((a = +e.milliseconds || 0) && t.setMilliseconds(t.getMilliseconds() + a),
        ...
        try {
          (e.millennia = 0),
            ...
            (function (e) {
              ...
              for (
                e.milliseconds < 0
                  ? ((t = g(-e.milliseconds / c)), (e.seconds -= t), (e.milliseconds += t * c))
                  : e.milliseconds >= c && ((e.seconds += T(e.milliseconds / c)), (e.milliseconds %= c)),
                  e.seconds < 0
                    ? ((t = g(-e.seconds / h)), (e.minutes -= t), (e.seconds += t * h))
                    : e.seconds >= h && ((e.minutes += T(e.seconds / h)), (e.seconds %= h)),
                  e.minutes < 0
                    ? ((t = g(-e.minutes / M)), (e.hours -= t), (e.minutes += t * M))
                    : e.minutes >= M && ((e.hours += T(e.minutes / M)), (e.minutes %= M)),
                  e.hours < 0
                    ? ((t = g(-e.hours / L)), (e.days -= t), (e.hours += t * L))
                    : e.hours >= L && ((e.days += T(e.hours / L)), (e.hours %= L));
                e.days < 0;
              ...
              e.days >= y && ((e.weeks += T(e.days / y)), (e.days %= y)),
                e.months < 0
                  ? ((t = g(-e.months / f)), (e.years -= t), (e.months += t * f))
                  : e.months >= f && ((e.years += T(e.months / f)), (e.months %= f)),
                e.years >= p &&
                  ...
                  e.decades >= k &&
                    ...
                    (e.decades %= k),
                    e.centuries >= D && ((e.millennia += T(e.centuries / D)), (e.centuries %= D))));
            })(e),
            (function (e, l, Y, g) {
              var v = 0;
              !(l & m) || v >= Y ? ((e.centuries += e.millennia * D), delete e.millennia) : e.millennia && v++,
                !(l & u) || v >= Y ? ((e.decades += e.centuries * k), delete e.centuries) : e.centuries && v++,
                !(l & o) || v >= Y ? ((e.years += e.decades * p), delete e.decades) : e.decades && v++,
                !(l & _) || v >= Y ? ((e.months += e.years * f), delete e.years) : e.years && v++,
                !(l & d) || v >= Y
                  ? (e.months && (e.days += w(e.refMonth, e.months)),
                    delete e.months,
                    e.days >= y && ((e.weeks += T(e.days / y)), (e.days %= y)))
                  : e.months && v++,
                !(l & i) || v >= Y ? ((e.days += e.weeks * y), delete e.weeks) : e.weeks && v++,
                !(l & r) || v >= Y ? ((e.hours += e.days * L), delete e.days) : e.days && v++,
                !(l & n) || v >= Y ? ((e.minutes += e.hours * M), delete e.hours) : e.hours && v++,
                !(l & s) || v >= Y ? ((e.seconds += e.minutes * h), delete e.minutes) : e.minutes && v++,
                !(l & a) || v >= Y ? ((e.milliseconds += e.seconds * c), delete e.seconds) : e.seconds && v++,
                (l & t && !(v >= Y)) || N(e, g);
            })(e, v, b, S);
        } finally {
          delete e.refMonth;
      ...
      function R(e, i, d, _, o) {
        ...
        'function' == typeof e
          ? ((u = e), (e = null))
          : e instanceof Date || (null !== e && isFinite(e) ? (e = new Date(+e)) : ('object' == typeof m && (m = e), (e = null)));
        var Y = null;
        if (
          ('function' == typeof i
            ? ((u = i), (i = null))
            : i instanceof Date || (null !== i && isFinite(i) ? (i = new Date(+i)) : ('object' == typeof i && (Y = i), (i = null))),
          m && (e = b(m, i)),
          Y && (i = b(Y, e)),
          !e && !i)
        )
  ...
  function (e, t, a) {
    ...
    !(function (e) {
      ...
      setInterval(function () {
        var a = t().countdown(
            e,
            t().countdown.MONTHS | t().countdown.DAYS | t().countdown.HOURS | t().countdown.MINUTES | t().countdown.SECONDS
          ),
          d = t().countdown(e);
        (d = Math.floor(1.1574074 * d.value * Math.pow(10, -8))),
          (s.innerText = d < 10 && d >= 0 ? '0' + d : d < 0 ? '00' : d),
          a.hours < 10 && a.hours >= 0 ? (n.innerText = '0' + a.hours) : (n.innerText = a.hours),
          a.minutes < 10 ? (r.innerText = '0' + a.minutes) : (r.innerText = a.minutes),
          a.seconds < 10 ? (i.innerText = '0' + a.seconds) : (i.innerText = a.seconds),
          d < 0 && a.hours < 0 && ((s.innerText = '00'), (n.innerText = '00'), (r.innerText = '00'), (i.innerText = '00'));
      }, 1e3);
    })(yourDate);
  },
]);
